...
const LearningSection: React.FC<LearningSectionProps> = ({ data }) => {
  return (
    <div className="w-full relative flex flex-col items-center justify-center h-full" style={{ transformStyle: 'preserve-3d' }}>
      ...
      <h2 className="text-4xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-300 mb-8 self-end pr-6 border-r-4 border-amber-500 text-right" style={{ transform: 'translateZ(50px)' }}>
        求知·进化
      </h2>
