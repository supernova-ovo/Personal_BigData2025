...
const SummarySection: React.FC<SummarySectionProps> = ({ data }) => {
  ...
  const keyword = useMemo(() => {
    ...
    if (Number(data.ZaiGangPX || 0) > 90) return "基地·守望者";
  ...
  const radarData = useMemo(() => [
    { subject: '坚守', A: Number(data.ZaiGangPX || 60), fullMark: 100 },
    { subject: '效能', A: Number(data.Apmpx || 70), fullMark: 100 },
    { subject: '资历', A: Math.min(Number(data.GongLingPX || 0), 100), fullMark: 100 },
    { subject: '学习', A: Math.min((data.ExamCiShu / 10) * 100, 100), fullMark: 100 },
    { subject: '影响', A: Math.min((data.Zancnt / 30) * 100, 100), fullMark: 100 },
    { subject: '勤勉', A: Number(data.DengLuPX || 80), fullMark: 100 },
  ], [data]);
