...
const EfficiencySection: React.FC<EfficiencySectionProps> = ({ data }) => {
  return (
    <div className="w-full relative flex flex-col items-center justify-center h-full px-4" style={{ transformStyle: 'preserve-3d' }}>
      ...
      <h2 className="text-4xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-400 to-purple-400 mb-8 self-end pr-4 border-r-4 border-fuchsia-500 text-right" style={{ transform: 'translateZ(50px)' }}>
        效能·风暴
      </h2>
      ...
      <div className="relative w-48 h-48 flex items-center justify-center mb-8" style={{ transform: 'translateZ(60px)' }}>
          ...
          <div className="relative z-10 text-center">
              ...
              <p className="text-xs font-bold text-fuchsia-300 tracking-[0.3em] mt-1">TOTAL APM</p>
