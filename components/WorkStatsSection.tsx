  ...
  return (
    <div className="space-y-6 w-full relative h-full flex flex-col justify-center" style={{ transformStyle: 'preserve-3d' }}>
      ...
      <div className="flex items-center space-x-3 mb-4" style={{ transform: 'translateZ(40px)' }}>
        ...
        <h2 className="text-4xl font-black italic text-white tracking-wide uppercase drop-shadow-lg leading-normal px-1">
      ...
      <p className="text-center text-xs text-cyan-200/50 italic font-bold tracking-widest" style={{ transform: 'translateZ(10px)' }}>// 效率为王</p>
    </div>
  );
};
