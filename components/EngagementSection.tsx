...
const EngagementSection: React.FC<EngagementSectionProps> = ({ data }) => {
  return (
    <div className="w-full relative flex flex-col items-center h-full justify-center" style={{ transformStyle: 'preserve-3d' }}>
       ...
       <h2 className="text-4xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400 mb-10 text-center" style={{ transform: 'translateZ(50px)' }}>
        共鸣·回响
      </h2>
