...
const TravelSection: React.FC<TravelSectionProps> = ({ data }) => {
  ...
  return (
    <div className="w-full relative flex flex-col items-center justify-center h-full" style={{ transformStyle: 'preserve-3d' }}>
      ...
      <h2 className="text-4xl font-black italic text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-green-300 mb-8 self-start pl-4 border-l-4 border-teal-500" style={{ transform: 'translateZ(50px)' }}>
        行无止境
      </h2>
